...
デザインシステムをコーディング用の AI Agent から活用する際、どのような方法が考えられるでしょうか？

一例としては MCP の提供が挙げられます。個人的には、以下の記事を参考にさせて頂いた記憶があります。
...
ということで、ようやく本題の弊社事例となりますが、サイボウズが提供するプロダクトの kintone では、kintone Design System と呼ばれるデザインシステムが製品開発チーム向けに提供されています。

https://note.com/amishiratori/n/n4caf80bb0954

実際にこれを Skills にしてみました。
...
また、Claude Code などであれば Slash Commands として明示的に呼び出せるようになるのも便利なポイントかと思います。
